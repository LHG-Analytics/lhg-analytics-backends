...
async function bootstrap() {
  try {
    ...
    SwaggerModule.setup('altana/api', app, document, {
      swaggerOptions: {
      ...
      customSiteTitle: 'LHG Analytics - Altana',
    });
    console.log('Swagger UI disponível em: /altana/api');
    ...
    const port = process.env.PORT_ALTANA || 3007;
    const defaultOrigins = [
      ...
      'http://localhost:3007', // Altana (Swagger)
    ...
    // Use a porta do ambiente ou 3002 como padrão
