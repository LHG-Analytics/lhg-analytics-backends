...
export class CronJobsService {
  ...
  @Cron('2 0,6,16 * * *', { timeZone: 'America/Sao_Paulo', disabled: true })
  async scheduleDailyJobs() {
    ...
    console.log(`Início da execução dos CronJobs do Lush Lapa: ${startTime}`);
    ...
    try {
      ...
      console.error('Erro ao executar os CronJobs do Lush Lapa:', error);
    } finally {
    ...
    console.log(`Fim da execução dos CronJobs do Lush Lapa: ${endTime}`);
  }
