/**
 * Serviço de Cache para KPIs
 * Fase 1.1, 1.3, 1.5 do plano de migração real-time
 *
 * Implementação em memória (sem Redis) para simplicidade inicial
 * Pode ser facilmente migrado para Redis no futuro
 */
...
export class KpiCacheService {
  ...
  constructor() {
    ...
    this.logger.log('KpiCacheService inicializado');
  }
  ...
  async getOrCalculate<T>(
    ...
    this.logger.log(`${service} KPIs calculados em ${calculationTime}ms`);
