...
export class RestaurantService {
  ...
  private async _calculateKpisByDateRangeInternal(startDate: Date, endDate: Date) {
    const abProductTypes = [26, 23, 24, 6, 7, 2, 22, 5, 31, 15, 12, 16, 9];

    const aProductTypes = [26, 23, 24, 6, 7, 2, 22, 5];

    const bProductTypes = [31, 15, 12, 16, 9];

    // Alimentos para ranking (sem 26)
    const aProductTypesForRanking = [23, 24, 6, 7, 2, 22, 5];

    // Bebidas para ranking (bProductTypes - nenhum removido)
    const bProductTypesForRanking = [31, 15, 12, 16, 9];

    // Alimentos para ranking de menos vendidos (sem 26)
    const aProductTypesForLeastRanking = [23, 24, 6, 7, 2, 22, 5];

    // Bebidas para ranking de menos vendidos (bProductTypes - nenhum removido)
    const bProductTypesForLeastRanking = [31, 15, 12, 16, 9];

    const othersList = [20, 25];
